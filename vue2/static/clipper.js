    ...
    Vue.prototype.crop  = function () {
      ...
      setTimeout(function () {
        ...
        if( imgData.length < (100 * 1024) ){
          ...
          self.newPicData=imgData;
          self.GLOBAL.picData=imgData;
          //图片上传
          ...
          image.onload = function () {
           ...
           // self.resultObj.src = data;
             self.newPicData=data;
             self.GLOBAL.picData=data;
            //图片上传
            self.postImg( data );
            self.uplaodImg();
          }
        ...
        //图片数据上传后台
    Vue.prototype.uplaodImg = function() {

      let _self=this;
      this.$http.post(
    '/plat/uplaodImg', {photo: _self.newPicData}
    ).then(function (res) {
        // console.log(res);
    }, function () {
        // 失败回调
